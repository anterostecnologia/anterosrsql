...
public class AnterosRSQLVisitor extends AbstractVoidContextNodeVisitor<String> {

    private final Function<Object, String> serializer;

    public AnterosRSQLVisitor() {
        this(DefaultSerializationStrategy.INSTANCE);
    }

    public AnterosRSQLVisitor(Function<Object, String> serializationStrategy) {
