...
import static br.com.anteros.rsql.query.builder.testsupport.QueryModel.QueryModelPredef.myListOfStrings;
...
import static br.com.anteros.rsql.query.builder.testsupport.QueryModel.QueryModelPredef.myString2;
...
import br.com.anteros.rsql.query.builder.testsupport.DomainModel;
import br.com.anteros.rsql.query.builder.testsupport.QueryModel;
import br.com.anteros.rsql.query.builder.visitors.AnterosPredicateVisitor;
...
public class PredicateVisitorTest {
    ...
    public class UserQuery extends AnterosQBuilder<UserQuery> {
    ...
    public void regularQueryTest() {
        ...
        Predicate<User> query = condition.query(new AnterosPredicateVisitor<>());
    ...
    public void enumTest() {
        ...
        assertTrue(query.query(new AnterosPredicateVisitor<>()).test(user));
    }
    ...
    private void compare(Condition<QueryModel> query, DomainModel... expected) {
        Predicate<DomainModel> pred = query.query(new AnterosPredicateVisitor<>());
